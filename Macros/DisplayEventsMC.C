...
void DisplayEventsMC(int t, int ene)
{
 ...
 float TckXYPos[nbl] = {4.0,6.0,6.0,6.25,9.0,9.0,9.0,9.0};
 ...
 for(int i=0;i<3;i++)ShellReg[i]=0;
 ...
 //Input file 
 //string Inppath="/home/sarah/AESOPLITE/MCProduction/V8";	
 string Inppath="/data/psmangeard/AESOPLITE2/AL2/TestOutput/V0/3";	
 string startfile="AL2NonUniB_V0";
 string endfile="_fort.99";
 string source = "test";
 //string directory= "/home/sarah/AESOPLITE/MCProduction/V8";
 string directory = "/data/psmangeard/AESOPLITE2/AL2/TestOutput/V0/3";
 string RecoInd="RK_test";
 ...
 int Nevents=0;
 //chain->Add(Form("%s/*Select.root*", Inppath.c_str()));
 chain->Add(Form("%s/RecoEvent_AL2NonUniB_V0_3_%dMeV0001_fort.99_RK.root",Inppath.c_str(),ene));
 TFile *fileout=new TFile(Form("%s/DisplayEventMC_%s_%dMeV_%d_%s.root", directory.c_str(),startfile.c_str(), type,ene,RecoInd.c_str()),"RECREATE");
 ...
 TH2F* Allchi2deltaP = new TH2F("","",chi2bin,chi2min,chi2max,deltaPbin,deltaPmin,deltaPmax);
 Allchi2deltaP->SetTitle("deltaP vs #chi_{2}");
 Allchi2deltaP->GetXaxis()->SetTitle("chi2_{reco}");
 Allchi2deltaP->GetYaxis()->SetTitle("(pTruth-pReco)/pTruth");
 Allchi2deltaP->GetYaxis()->SetTitleSize(0.03);
 Allchi2deltaP->GetYaxis()->SetTitleOffset(1.60);
 Allchi2deltaP->GetYaxis()->SetLabelSize(0.03);
 Allchi2deltaP->GetXaxis()->SetTitleSize(0.03);
 Allchi2deltaP->GetXaxis()->SetTitleOffset(1.60);
 Allchi2deltaP->GetXaxis()->SetLabelSize(0.03);
	

 TH2F* Allchi2BdeltaP = new TH2F("","",chi2bin,chi2min,chi2max,deltaPbin,deltaPmin,deltaPmax);
 Allchi2BdeltaP->SetTitle("deltaP vs #chi_{BPR}");
 Allchi2BdeltaP->GetXaxis()->SetTitle("chi2_{BPR}");
 Allchi2BdeltaP->GetYaxis()->SetTitle("(pTruth-pReco)/pTruth");
 Allchi2BdeltaP->GetYaxis()->SetTitleSize(0.03);
 Allchi2BdeltaP->GetYaxis()->SetTitleOffset(1.60);
 Allchi2BdeltaP->GetYaxis()->SetLabelSize(0.03);
 Allchi2BdeltaP->GetXaxis()->SetTitleSize(0.03);
 Allchi2BdeltaP->GetXaxis()->SetTitleOffset(1.60);
 Allchi2BdeltaP->GetXaxis()->SetLabelSize(0.03);
	
 TH2F* Allchi2NBdeltaP = new TH2F("","",chi2bin,chi2min,chi2max,deltaPbin,deltaPmin,deltaPmax);
 Allchi2NBdeltaP->SetTitle("deltaP vs #chi_{NBPR}");
 Allchi2NBdeltaP->GetXaxis()->SetTitle("chi2_{NB}");
 Allchi2NBdeltaP->GetYaxis()->SetTitle("(pTruth-pReco)/pTruth");

 Allchi2NBdeltaP->GetYaxis()->SetTitleSize(0.03);
 Allchi2NBdeltaP->GetYaxis()->SetTitleOffset(1.60);
 Allchi2NBdeltaP->GetYaxis()->SetLabelSize(0.03);
 Allchi2NBdeltaP->GetXaxis()->SetTitleSize(0.03);
 Allchi2NBdeltaP->GetXaxis()->SetTitleOffset(1.60);
 Allchi2NBdeltaP->GetXaxis()->SetLabelSize(0.03);

 TH3F* Allchi2PRdeltaP = new TH3F("","",chi2bin,chi2min,chi2max,chi2bin,chi2min,chi2max, deltaPbin,deltaPmin,deltaPmax);
 Allchi2PRdeltaP->SetTitle("deltaP vs #chi_{NBPR} VS #chi_{PR}");
 Allchi2PRdeltaP->GetXaxis()->SetTitle("chi2_{NB}");
 Allchi2PRdeltaP->GetYaxis()->SetTitle("chi2_{B}");
 Allchi2PRdeltaP->GetZaxis()->SetTitle("(pTruth-pReco)/pTruth");
	
 Allchi2PRdeltaP->GetYaxis()->SetTitleSize(0.03);
 Allchi2NBdeltaP->GetYaxis()->SetTitleOffset(1.60);
 Allchi2PRdeltaP->GetYaxis()->SetLabelSize(0.03);
 Allchi2PRdeltaP->GetXaxis()->SetTitleSize(0.03);
 Allchi2PRdeltaP->GetXaxis()->SetTitleOffset(1.60);
 Allchi2PRdeltaP->GetXaxis()->SetLabelSize(0.03);
 ...
 for(int i=0;i<Nevents;i++)
   {
    ...
    double deltaP = 100*fabs(p0MC-preco)/(p0MC);
    double deltaPpPR = 100*fabs(p0MC-pPR)/(p0MC);
    Allchi2deltaP->Fill(chireco,deltaP);
    Allchi2BdeltaP->Fill(chiBPR,deltaP);
    Allchi2NBdeltaP->Fill(chiNBPR,deltaP);
    Allchi2PRdeltaP->Fill(chiNBPR,chiBPR,deltaP);
    ...
    PHG->AddText(Form("G=%4.2f MeV", EG));
    ...
    TPaveText*Def=new TPaveText(-28,-45,0,-35);
    ...
    if(firstpage==0) can->Print(Form("%s/EventDisplayMC_%d_%dMeV_%s.pdf(", directory.c_str(),type,ene,RecoInd.c_str()),Form("Title:Event %d",e->get_eventnumber()));
    else can->Print(Form("%s/EventDisplayMC_%d_%dMeV_%s.pdf", directory.c_str(),type,ene,RecoInd.c_str()),Form("Title:Event %d",e->get_eventnumber()));

	firstpage=-1;
    delete can;
   }//i
	
TCanvas *Canchi2 = new TCanvas("canvas","can",200,10,1400,1200);
Canchi2->cd(1);
gStyle->SetPalette(kBird);
Allchi2deltaP->Draw("LEGO2Z");
fileout->cd();
Allchi2deltaP->Write();
Canchi2->Write();
							  
TCanvas *Canchi2BPR = new TCanvas("canvasBPR","canBPR",200,10,1400,1200);
Canchi2BPR->cd(1);
gStyle->SetPalette(kBird);
Allchi2BdeltaP->Draw("LEGO2Z");
fileout->cd();
Allchi2BdeltaP->Write();
Canchi2BPR->Write();
							   
TCanvas *Canchi2NBPR = new TCanvas("canvasNBPR","canNBPR",200,10,1400,1200);
Canchi2NBPR->cd(1);
gStyle->SetPalette(kBird);
Allchi2NBdeltaP->Draw("LEGO2Z");
fileout->cd();
Allchi2NBdeltaP->Write();
Canchi2NBPR->Write();

TCanvas *Canchi2PR = new TCanvas("canvasPR","canPR",200,10,1400,1200);
Canchi2PR->cd(1);
Allchi2PRdeltaP->Draw("BOX");
fileout->cd();
Allchi2PRdeltaP->Write();
Canchi2PR->Write();
							   

fileout->Close();
can=new TCanvas();
can->Print(Form("%s/EventDisplayMC_%d_%dMeV_%s.pdf)", directory.c_str(),type,ene,RecoInd.c_str()));
...
//    if(e->get_chi2()>0) continue;
   ...
   // if(e->get_chi2B()<=0||e->get_chi2B()<10) continue;
    ...
    Tchi2B->SetFillStyle(0);Tchi2B->SetBorderSize(0);
    Tchi2B->SetTextColor(kBlue);
    Tchi2B->AddText(Form("#chi^{2}= %6.4f",e->get_chi2()));
    Tchi2B->Draw();
