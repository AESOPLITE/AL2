...
{	
 ...
 outputTXT << Form("%s", "T1r") << " ";    
 outputTXT << Form("%s", "T2r") << " ";    
 outputTXT << Form("%s", "T3r") << " ";    
 outputTXT << Form("%s", "T4r") << " ";    
 outputTXT << Form("%s", "Gr") << " ";    
 outputTXT << Form("%s", "L0r") << " ";    
 outputTXT << Form("%s", "L1r") << " ";    
 outputTXT << Form("%s", "L2r") << " ";    
 outputTXT << Form("%s", "L3r") << " ";    
 outputTXT << Form("%s", "L4r") << " ";    
 outputTXT << Form("%s", "L5r") << " ";    
 outputTXT << Form("%s", "L6r") << " ";    
 outputTXT << Form("%s", "L7r") << " ";    
 ...
 for (int m=0;m<nentries;m++)
   {
    ...
    //Guard
    int nToF = e->get_ToF().size();
    if(nToF>0){for(int k=0; k<nToF; k++) ToF+=e->get_ToF().at(k);}
    ...
    int year=e->get_yPSE1b();
    int month=e->get_mPSE1b();
    int day=e->get_dPSE1b();
    int hour=e->get_hPSE1b();
    int minute=e->get_miPSE1b();
    int second=e->get_sPSE1b();
    ...
    outputTXT << Form("%5d", e->get_T1r()) << " ";    
    outputTXT << Form("%5d", e->get_T2r()) << " ";    
    outputTXT << Form("%5d", e->get_T3r()) << " ";    
    outputTXT << Form("%5d", e->get_T4r()) << " ";    
    outputTXT << Form("%5d", e->get_Gr()) << " ";     
    outputTXT << Form("%d", e->get_Lrate(0)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(1)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(2)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(3)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(4)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(5)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(6)) << " ";
    outputTXT << Form("%d",  e->get_Lrate(7)) << " ";
    outputTXT <<endl;
   }//m number of entries
 outputTXT.close();
 filein->Close();
