...
int main(int argc, char*argv[])
{
 ...
 if(argc!=7)
  {
   ...
   cout << "The program needs 6 input parameters:"<< endl;
 ...
 string Inppath="/data/Documents/UDEL/AESOPLITE2/MC/Fluka4/V0";
 ...
 string Outpath="/data/Documents/UDEL/AESOPLITE2/AL2/TestOutput/V0";
