...
int main(int argc, char*argv[]) 
{
 ...
 //BC BH BB BA BE BF BI BD
 
 float ladderOffsetLeft[8] =  {8.904, 8.873, 8.866, 8.889, 8.886, 8.903, 8.881, 8.871 };
 float ladderOffsetRight[8] = {98.478,98.460,98.447,98.472,98.458,98.500,98.461,98.465 };
