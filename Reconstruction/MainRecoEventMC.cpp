...
int main(int argc, char*argv[]) 
{
 ...
 // UNKNOWN CONFIGURAITON FOR THE TWO LAYERS
 //L0 L1 L2 L3 L4 L5 L6 L7
 //BC   BC BB BA BD BE BI BG
 
 float ladderOffsetLeft[8] =  { 8.904, 8.904, 8.866, 8.889, 8.871, 8.886, 8.881, 8.884};
 float ladderOffsetRight[8] = {98.478,98.478,98.447,98.472,98.465,98.458,98.461,98.466};
